...
aral/0.2.12 darwin-x64 node-v8.11.4
$ aral --help [COMMAND]
USAGE
  $ aral COMMAND
...
...
_See code: [src/commands/config.ts](https://github.com/11arn11/aral/blob/v0.2.12/src/commands/config.ts)_
...
_See code: [src/commands/destroyAll.ts](https://github.com/11arn11/aral/blob/v0.2.12/src/commands/destroyAll.ts)_
...
_See code: [src/commands/init.ts](https://github.com/11arn11/aral/blob/v0.2.12/src/commands/init.ts)_
...
_See code: [src/commands/start.ts](https://github.com/11arn11/aral/blob/v0.2.12/src/commands/start.ts)_
<!-- commandsstop -->
